...
# HYPER_PARAMETERS
hidden_layer1 = 11  #number of hidden layers on 1
hidden_layer2 = 11 #number of hidden layers on 2
hidden_layer3 = 11 #number of hidden layers on 3
hidden_layer4 = 11 #number of hidden layers on 4
batch_number = 100
gamma = 0.99995
...
w5 = tf.Variable(tf.random_uniform([hidden_layer4, env.action_space.n], -0.10, 0.10))
...
w5_prime = tf.Variable(tf.random_uniform([hidden_layer4, env.action_space.n], -1.0, 1.0))
...
#lists of assigns
all_assigns = [w1_prime_update, w2_prime_update, w3_prime_update,w4_prime_update, w5_prime_update,
                b1_prime_update, b2_prime_update, b3_prime_update, b4_prime_update,b5_prime_update]
...
#Q-Value
Q = tf.matmul(hidden_activationfx_4, w5) + b5
...
#Q Prime Value
Q_prime =  tf.matmul(hidden_activationfx_4_prime, w5_prime) + b5_prime
